import {
  require_crypto
} from "./chunk-AH6GY2CF.js";
import {
  require_base64_js,
  require_isarray
} from "./chunk-64HVY7T2.js";
import {
  Buffer,
  __commonJS,
  __esm,
...
function randomBytes(nBytes) {
  return import_buffer10.Buffer.from(new WordArray().random(nBytes).toString(), "hex");
}
...
var AuthenticationHelper = function() {
  function AuthenticationHelper2(PoolName) {
    ...
    this.infoBits = import_buffer10.Buffer.from("Caldera Derived Key", "utf8");
  ...
  _proto.hash = function hash(buf) {
    ...
    var hashHex = import_buffer10.Buffer.from(resultFromAWSCrypto).toString("hex");
    return new Array(64 - hashHex.length).join("0") + hashHex;
  };
  _proto.hexHash = function hexHash(hexStr) {
    return this.hash(import_buffer10.Buffer.from(hexStr, "hex"));
  };
  _proto.computehkdf = function computehkdf(ikm, salt) {
    var infoBitsBuffer = import_buffer10.Buffer.concat([this.infoBits, import_buffer10.Buffer.from(String.fromCharCode(1), "utf8")]);
  ...
  _proto.getPasswordAuthenticationKey = function getPasswordAuthenticationKey(username, password, serverBValue, salt, callback) {
    ...
    this.calculateS(xValue, serverBValue, function(err, sValue) {
      ...
      var hkdf = _this4.computehkdf(import_buffer10.Buffer.from(_this4.padHex(sValue), "hex"), import_buffer10.Buffer.from(_this4.padHex(_this4.UValue), "hex"));
      callback(null, hkdf);
    });
  };
...
var CognitoJwtToken = function() {
  ...
  _proto.decodePayload = function decodePayload() {
    ...
    try {
      return JSON.parse(import_buffer12.Buffer.from(payload, "base64").toString("utf8"));
    } catch (err) {
      return {};
    }
  };
    ...
    authenticationHelper.getLargeAValue(function(errOnAValue, aValue) {
      ...
      _this2.client.request("InitiateAuth", jsonReq, function(err, data) {
        ...
        authenticationHelper.getPasswordAuthenticationKey(_this2.username, authDetails.getPassword(), serverBValue, salt, function(errOnHkdf, hkdf) {
          ...
          var concatBuffer = import_buffer23.Buffer.concat([import_buffer23.Buffer.from(_this2.pool.getUserPoolName(), "utf8"), import_buffer23.Buffer.from(_this2.username, "utf8"), import_buffer23.Buffer.from(challengeParameters.SECRET_BLOCK, "base64"), import_buffer23.Buffer.from(dateNow, "utf8")]);
          var awsCryptoHash = new import_sha256_js2.Sha256(hkdf);
          awsCryptoHash.update(concatBuffer);
          var resultFromAWSCrypto = awsCryptoHash.digestSync();
          var signatureString = import_buffer23.Buffer.from(resultFromAWSCrypto).toString("base64");
  ...
  _proto.authenticateUserInternal = function authenticateUserInternal(dataAuthenticate, authenticationHelper, callback) {
    ...
    authenticationHelper.generateHashDevice(dataAuthenticate.AuthenticationResult.NewDeviceMetadata.DeviceGroupKey, dataAuthenticate.AuthenticationResult.NewDeviceMetadata.DeviceKey, function(errGenHash) {
      ...
      var deviceSecretVerifierConfig = {
        Salt: import_buffer23.Buffer.from(authenticationHelper.getSaltDevices(), "hex").toString("base64"),
        PasswordVerifier: import_buffer23.Buffer.from(authenticationHelper.getVerifierDevices(), "hex").toString("base64")
      };
    ...
    authenticationHelper.getLargeAValue(function(errAValue, aValue) {
      ...
      _this6.client.request("RespondToAuthChallenge", jsonReq, function(err, data) {
        ...
        authenticationHelper.getPasswordAuthenticationKey(_this6.deviceKey, _this6.randomPassword, serverBValue, salt, function(errHkdf, hkdf) {
          ...
          var dateNow = dateHelper.getNowString();
          var concatBuffer = import_buffer23.Buffer.concat([import_buffer23.Buffer.from(_this6.deviceGroupKey, "utf8"), import_buffer23.Buffer.from(_this6.deviceKey, "utf8"), import_buffer23.Buffer.from(challengeParameters.SECRET_BLOCK, "base64"), import_buffer23.Buffer.from(dateNow, "utf8")]);
          var awsCryptoHash = new import_sha256_js2.Sha256(hkdf);
          awsCryptoHash.update(concatBuffer);
          var resultFromAWSCrypto = awsCryptoHash.digestSync();
          var signatureString = import_buffer23.Buffer.from(resultFromAWSCrypto).toString("base64");
